...
> This is the **record copy** per canon-cc-010 ("records are Codex"); the
> Province-operative copy lives at `sproutlab/docs/MODEL_SELECTION_PROTOCOL.md`
> and wins on in-Province routing (canon-cc-026 as amended 2026-06-10). Keep
> the two in sync rather than fork. Formal ratification via the canon-cc-027
> chain is pending; until then this is Architect-commissioned working doctrine.
