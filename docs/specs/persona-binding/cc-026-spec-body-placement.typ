...
#align(center)[
  #v(2cm)
  #text(24pt, weight: "bold", fill: warm-dark)[Canon cc-026]
  #v(0.3em)
  #text(18pt, weight: "bold", fill: warm-dark)[Spec Body Placement]
  #v(0.3em)
  #text(13pt, fill: warm, style: "italic")[Part 6 of 10 · Persona-Binding Suite]
  #v(1.5cm)
]

#meta-table(
  [*Slot*], [canon-cc-026],
  [*Title*], [Spec Body Placement — Canonical Specs and Province Deployables],
  ...
  [*Created*], [2026-04-19],
  [*Covers*], [Canonical specs in Codex · Spec file format (YAML frontmatter + Markdown) · Deployables in Province `.claude/` · Replication rules (Censors cluster-wide, Governors Province-only, cross-cluster roles everywhere) · Unidirectional sync · Monument deploy accountability · Per-Province layout],
  [*Depends on*], [cc-022 (binding rule), cc-023 (extension protocol populates the invocation_modes these specs render), cc-027 (signing chain governs spec-body amendments)],
)
