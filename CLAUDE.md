...
- **Tribune (Book II Art. 4-bis, draft 2026-09-01):** a right of *interposition* attached to a seated Censor's office — an objection stays any act below the Sovereign until answered on the record. Not a rung, not a Cabinet seat, not a veto. First holder **Nyx**, attached to her Cluster B + D censorial seats.
...
- **Clusters:** A = Codex + SproutLab + MSc (Censor: Cipher; MSc enrolled 2026-05-19 per canon-inst-004 on censorial-absorbability grounds). B = SEP Invoicing + SEP Dashboard + SEP-Ops/`soma-internal` (Censor: Nyx — **except SEP-Ops, whose Edict V pass stays with Cipher by Sovereign ruling 2026-09-01: the Republic's first per-Province censorial exception**). SEP-Ops admitted 2026-09-01, decree 0022. C = Command Center + Temple of Mars, the Monument class (Censor: Cipher — **INTERIM since 2026-05-24 per canon-inst-003, seat open for a successor**; "Monument" persists as a Province-class attribute, not a cluster). D = MyFin, Finance (Censor: **Nyx**, seated 2026-09-01 decree 0023 — dual-hatted with Cluster B; cluster ratified 2026-08-26 decree 0020). **All four Cluster Censor seats now filled** (Cipher A + C-interim, Nyx B + D). **Corporate parallel:** Studio (A) / SEP (B) / Monument Bloc (C) / Finance (D).
...
Key actively enforced: Canon 0033 (build.sh outputs directly), Canon 0034 (SWs never cache HTML), Canon 0001-0012 (SproutLab HRs, originated there). canon-cc-015 through canon-cc-026 (post-Constitution architectural suite incl. spec-mirror discipline). canon-inst-001 / canon-inst-002 (Aurelius→Orinth + Priesthood); canon-inst-004 (MSc enrolled in Cluster A); canon-inst-005 (CodeMike seated MSc Builder, first Gen 1). canon-inst-003 (Ignis seated Temple of Mars Builder; Cluster C established as the Monument class; Cipher named interim Cluster C Censor — **ratified 2026-05-24**, no longer reserved). canon-pers-001 (CLAUDE.md persona-header reserved to Orinth post canon-inst-001). canon-pers-002 (Corporate Parallel Title Mapping; 2026-05-02). canon-proc-006 (the Scribe Worker Tier; 2026-05-22).
