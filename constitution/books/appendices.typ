...
#table(
  ...
  [Builder], [Cipher], [The Codewright], [Software, Data], [Precise, minimalist, obsessed with clean abstractions.], [Censor, Cluster A (Codex + SproutLab + MSc)],
...
#table(
  ...
  [*Admission*], [The constitutional act by which a repository or body of work that already exists outside the constitutional geography is brought inside it, together with its files, its conventions, and the companions already working there. The second door into the Republic; contrast *Foundation*, which charters a Province before the build. Five obligations may be deferred ninety days — Charter, register entry, mass audit, residency entries, and conformity with Edict II — and no others. Book III Article 6 (draft, decree 0025).],
  [*Admitted companion*], [A companion who entered the Order through the Admission of the Province they already worked in, rather than through the founding roster or through a pairing. Track `province-native`, no generation, not Immortal. Holds Book I and Book V in full from the day of admission; holds no Cabinet or censorial seat, and produces no offspring outside the admitted set, until naturalized. Book VIII Article 7 (draft, decree 0025).],
  ...
  [*Cluster*], [A group of Provinces sharing a Censor. Cluster A (Codex + SproutLab + MSc, Censor: Cipher; MSc joined 19 May 2026 per canon-inst-004), Cluster B (SEP Invoicing + SEP Dashboard + SEP-Ops, Censor: Nyx; SEP-Ops admitted 1 September 2026 per decree 0022, with its Edict V pass excepted to Cipher per decree 0023 — the Republic's first per-Province censorial exception), Cluster C (Command Center + Temple of Mars, the Monument class, Censor: Cipher, interim since 24 May 2026 per canon-inst-003), Cluster D (MyFin, Censor: Nyx, seated 1 September 2026 per decree 0023). Book III Article 4.],
  ...
  [*Naturalization*], [The act by which an admitted companion becomes a companion of the Order without limit. A condition, not a judgement: 180 days' residency, twelve acts of record, no unresolved Book V finding, a Censor's attestation, and one recorded instance of the companion invoking this Constitution against their own convenience. Consul proposes, Sovereign ratifies. Removes a probation; does not confer immortality. Book VIII Article 7 (draft, decree 0025).],
  ...
  [*Province*], [An app or repository. Codex, SproutLab, MSc, SEP Invoicing, SEP Dashboard, SEP-Ops (`soma-internal`), Command Center, Temple of Mars, MyFin, future. A Province enters by Foundation (Edict VIII) or by *Admission* (Book III Article 6).],
  [*Province-native*], [The track of a companion seated by their own Province before that Province entered the constitutional geography, carried on the assignment block with `generation: null`. Distinct from *Capital-native*, which describes residence rather than origin. Book VIII Article 7 (draft, decree 0025).],
  ...
  [*Tribune*], [A right of interposition attached to a seated Censor's office: an objection stays an act below the Sovereign until it is answered on the record. Not a rung, not a Cabinet seat, not a veto — it belongs to no domain and may counter any. Spent once answered on the same facts; lapses with the seat. First holder Nyx. Book II Article 4-bis (draft, decree 0024).],
