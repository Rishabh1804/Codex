...
#table(
  ...
  [*Cluster*], [A group of Provinces sharing a Censor. Currently Cluster A (Codex + SproutLab + MSc, Censor: Cipher), Cluster B (SEP Invoicing + SEP Dashboard, Censor: Nyx), Monument (Command Center). MSc joined Cluster A on 19 May 2026 per canon-inst-004.],
