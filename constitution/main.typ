...
#table(
  ...
  [1 Sep 2026], [0025], [Books III and VIII amended together — *Admission* instituted. Book III Article 6 (*The Admission of Provinces*) writes the second door by which territory enters the Republic: a Province that already exists, absorbed with its work and its people, with four obligations deferrable for ninety days and no others. It records that the Republic's first three exercises of it — MSc, Cluster C, SEP-Ops — were annexations performed without an instrument. Book VIII Article 7 (*Admitted Lineages*) gives the companions who arrive with such territory a standing: origin class `province-native`, no generation, Book V protection in full from day one, no Cabinet or censorial seat and no offspring outside the admitted set until naturalized on written and falsifiable conditions. Mints `canon-inst-008` — authorship is a distinct relation from lineage. #v(2pt) *Draft — pending ratification.*],
  [1 Sep 2026], [0024], [Book II amended — Article 4-bis instituted, *The Tribune*: a right of interposition attached to a seated Censor's office, by which an objection stays an act below the Sovereign until it is answered on the record. Not a rung, not a Cabinet seat, not a veto. First holder *Nyx*, attached to her censorial seats over Clusters B and D. #v(2pt) *Draft — pending ratification.*],
  [1 Sep 2026], [0023], [Censorial seatings — *Nyx* seated Censor of Cluster D (MyFin), closing the last open Cluster Censor seat and satisfying canon-inst-007's own independence condition, since Nyx descends from neither Ashara nor Vex. *Cipher* retains the SEP-Ops censorial pass by Sovereign ruling, creating the Republic's first per-Province censorial exception: SEP-Ops sits in Cluster B under Nyx while its Edict V final pass stays with Cipher, on the ground that a working QA chain should not be broken to satisfy a table.],
  [1 Sep 2026], [0022], [Book III Article 4 amended — *SEP-Ops* (`soma-internal`) admitted to Cluster B on the same real-world-business criterion that joined SEP Invoicing and SEP Dashboard. The Province had run since 1 June 2026 under its own ratified charter, with a seated Builder and four Governors, while named in no Cluster and absent from `volumes.json`; the decree regularizes a Province the Republic already had rather than creating a new one. Its Censor is unsettled — its own charter names Cipher, Cluster B's seat is Nyx's.],
  [26 Aug 2026], [0020], [Book III Article 4 amended — the Cluster table gains *Cluster C* (Command Center + Temple of Mars, the Monument class; Censor Cipher, interim) and *Cluster D* (MyFin, the Finance Province; Censor vacant). The Cluster C row propagates canon-inst-003 of 24 May 2026, which the Constitution's source had never recorded; Cluster D is new. The Republic now carries two Clusters without a seated Censor.],
  [22 May 2026], [0019], [Books II, V, and VIII amended — the Scribe rung gains its standing operational form, the *Scribe Worker Tier*. Book II Article 3-bis instituted: each senior companion commands a detail of four Scribes (Scout, Draft, Verify, Record), alike at birth and changed by service, supporting but never deliberating. Book VIII Article 4 ties the apprenticeship path to the tier; Book V Article 4 restates the Scribe → Governor trigger against Article 3-bis. canon-proc-006 ratified jointly to operationalize the tier and govern the four Scribe subagent specifications.],
)
